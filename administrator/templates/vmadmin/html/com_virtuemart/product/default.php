 ...
 * @revision $Rev
 * @version $Id: default.php 11100 2024-12-11 14:40:05Z Milbo $
 *
 */
...
?>
	<form action="index.php?option=com_virtuemart&view=product" method="post" name="adminForm" id="adminForm">
		...
		<table class="uk-table uk-table-small uk-table-striped uk-table-responsive">
			...
			<tbody class="vmuikit-js-sortable">
			<?php
						...
						<?php if ($this->showOrdering) { ?>
							<td class="order">
								...
								<?php if ($this->showOrdering == $product->virtuemart_category_id) {
									...
									if ($this->showDrag) { ?>
                                        <div class="uk-sortable-handle" ><span class="" uk-icon="icon: move; ratio: 1"></span></div>
									<?php }
