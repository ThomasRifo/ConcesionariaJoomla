...
*/
	...
	class vmVersion {
		...
		static $RELEASE = '4.4.4';
		/** @var string Development Status */
		static $DEV_STATUS = 'BUGFIX';
		/** @var string Codename */
		static $CODENAME = 'Wise Eagle Owl';
		/** @var string Date */
		static $RELDATE = '4. Januar 2025';
		/** @var string Time */
		static $RELTIME = '0916';
		/** @var string Timezone */
		static $RELTZ = 'GMT';
		/** @var string Revision */
		static $REVISION = '11101';
		/** @var string Copyright Text */
		static $COPYRIGHT = 'Copyright (C) 2004 - %2025 Virtuemart Team. All rights reserved.';
		/** @var string URL */
