...
/**
 *
 * @version $Id: currencydisplay.php 11101 2025-01-03 11:25:45Z Milbo $
 * @package VirtueMart
 * @subpackage classes
 *
 * @author Max Milbers
...
class CurrencyDisplay {
	...
	public $_currency_id   = '0';		// string ID related with the currency (ex : language)
	public $_symbol    		= 'udef';	// Printable symbol
	...
	static public function getInstance( $currencyId=0, $vendorId=0, $user_currency_rate = 0){
		...
		if (!isset(self::$_instance[$h])) {
			...
			if($user_currency_rate!=0){
				...
				self::$_instance[$h]->exchangeRateShopper = 0;
			}
		}
