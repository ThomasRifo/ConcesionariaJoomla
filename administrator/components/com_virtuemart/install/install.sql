...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Administration Menu Items' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_categories` (
  ...
  KEY `shared` (`shared`),
  KEY `ordering` (`ordering`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Product Categories are stored here' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Category child-parent relation list';
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_countries` (
  ...
  KEY `ordering` (`ordering`),
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Country records' ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_coupons` (
  ...
  `virtuemart_coupon_max_attempt_per_user` TINYINT(1) NOT NULL,
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime,
  `created_by` int(1) NOT NULL DEFAULT '0',
  `modified_on` datetime,
  ...
  `locked_by` int(1) NOT NULL DEFAULT '0',
   ...
   KEY `published` (`published`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Used to store coupon codes' ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_currencies` (
  ...
  `currency_numeric_code` smallint(1),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Used to store currencies';
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_manufacturers` (
  ...
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Manufacturers are those who deliver products' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_manufacturercategories` (
  ...
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Manufacturers are assigned to these categories' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_medias` (
  ...
  KEY `shared` (`shared`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Additional Images and Files which are assigned to products' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_migration_oldtonew_ids` (
	    ...
	    `orders_start` int(1),
	    PRIMARY KEY (`id`)
	) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='xref table for vm1 ids to vm2 ids' ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_modules` (
  ...
  KEY `ordering` (`ordering`),
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='VirtueMart Core Modules, not: Joomla modules' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_order_calc_rules` (
  ...
  KEY `virtuemart_order_id` (`virtuemart_order_id`),
  KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Stores all calculation rules which are part of an order' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_orderstates` (
  ...
  KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`),
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='All available order statuses' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_paymentmethods` (
  ...
  PRIMARY KEY (`virtuemart_paymentmethod_id`),
	...
	KEY `ordering` (`ordering`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='The payment methods of your store' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='xref table for paymentmethods to shoppergroup' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='All products are stored here.' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_categories` (
  ...
  KEY `ordering` (`ordering`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Maps Products to Categories';
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_customfields` (
  ...
  UNIQUE KEY `unique_custf_prd_value` (`virtuemart_customfield_id`,`virtuemart_product_id`,`virtuemart_custom_id`,`customfield_value`(200)),
  KEY `unique_cust_prd_value` (`virtuemart_custom_id`,`virtuemart_product_id`,`customfield_value`(200)),
  KEY `customfield_value` (`customfield_value`(200)),
  KEY `virtuemart_product_id` (`virtuemart_product_id`,`ordering`),
  KEY `virtuemart_custom_id` (`virtuemart_custom_id`),
  KEY `published` (`published`),
  KEY `ordering` (`ordering`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='custom fields' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Maps a product to a manufacturer';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Holds price records for a product' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_ratings` (
  ...
  KEY `published` (`published`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='Stores all ratings for a product';
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_shipmentmethods` (
  ...
  PRIMARY KEY (`virtuemart_shipmentmethod_id`),
	...
	KEY `ordering` (`ordering`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Shipment created from the shipment plugins' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='xref table for shipment to shoppergroup' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_shoppergroups` (
  ...
  KEY `shared` (`shared`),
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Shopper Groups that users can be assigned to' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_states` (
  ...
  KEY `shared` (`shared`),
  KEY `published` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='States that are assigned to a country' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_userfields` (
  ...
  KEY `cart` (`cart`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Holds the fields for the user information' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Holds the different values for dropdown and radio lists' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='Vendors manage their products in your store' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1 COMMENT='xref table for users to shopper group' ;
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_worldzones` (
  ...
  KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci COMMENT='The Zones managed by the Zone Shipment Module' AUTO_INCREMENT=1 ;
