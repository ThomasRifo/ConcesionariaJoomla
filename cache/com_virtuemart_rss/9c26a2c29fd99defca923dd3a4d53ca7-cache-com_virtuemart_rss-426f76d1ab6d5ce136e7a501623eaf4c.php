<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";a:5:{i:0;O:8:"stdClass":3:{s:4:"link";s:62:"https://virtuemart.net/news/security-and-bugfix-release-4-4-10";s:5:"title";s:44:"Important Security and Bugfix release 4.4.10";s:11:"description";s:1177:"<p>Whats going on here? 3rd security release within 6 months? Yes that is unusual, but better the leaks are found and closed than wrong safety feeling. In this special case we provide also the fix for old installations. It should work for any installation higher than vm3.6</p>
<p style="text-align: center;"><a class="btn btn-primary" href="https://dev.virtuemart.net/attachments/1394/com_virtuemart.4.4.10.11120_package_or_extract.zip">DOWNLOAD VirtueMart 4.4.10<br />NOW</a></p>
<p style="text-align: center;"><a class="btn btn-primary" href="https://dev.virtuemart.net/attachments/1395/HOTFIX_com_virtuemart_patcher_vm3.6_vm4.4.8.zip">DOWNLOAD Hotfix for VM3.6 - VM4.4.8</a></p>
<p>Features:</p>
<ul>
<li>We added a new function checkByShowColumns which executes a basic check based on the table definition for data to be stored in the db</li>
</ul>
<p>Fixes/Enhancements:</p>
<ul>
<li>Enhanced multi uploader to better use existing code</li>
<li>fixed display of file type as icon</li>
<li>Product module cache considers chosen currency</li>
<li>Little fix for eWay to reflect namespacing</li>
<li>PayPal Checkout fixed wrongly forced currency for hosted fields</li>
</ul>";}i:1;O:8:"stdClass":3:{s:4:"link";s:61:"https://virtuemart.net/news/security-and-bugfix-release-4-4-8";s:5:"title";s:50:"Security and Bugfix release 4.4.8 - Discord Server";s:11:"description";s:2514:"<p>The security issue requires the permission to edit categories, so it is even likely that no shop is affected. Only multivendor shops that allow category editing may be affected. This issue was found by Adam Wallwork.</p>
...
<p style="text-align: center;"><a class="btn btn-primary" href="https://dev.virtuemart.net/attachments/1393">DOWNLOAD VirtueMart 4.4.6<br />NOW</a> without membership</p>";}i:2;O:8:"stdClass":3:{s:4:"link";s:48:"https://virtuemart.net/news/bugfix-release-4-4-6";s:5:"title";s:20:"Bugfix release 4.4.6";s:11:"description";s:2724:"<p>I am sorry guys, the last release was rushed by the security issue and I underestimated that testers were not testing due holidays, silvester and all that. This version now is tested very well. Many hours by different testers went into testing. I added a small tool, which fixes all images which lost the image property for you.</p>
...
</ul>";}i:3;O:8:"stdClass":3:{s:4:"link";s:50:"https://virtuemart.net/news/security-release-4-4-4";s:5:"title";s:29:"Security release 4.4.4 Update";s:11:"description";s:1306:"<p>From time to time it happens. We have an XSS issue. Reported by Aman Rai. More Infos later. Version vm4.4.4 has a fix to prevent them.</p>
