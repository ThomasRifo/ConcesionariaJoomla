 ...
 * @version $Id: view.html.php 11097 2024-11-21 20:42:45Z Milbo $
 */
    ...
    /**
		...
		function display($tpl = null) {
			...
			if($superVendor == 1 or (vmAccess::manager('product') and $superVendor==$product->virtuemart_vendor_id)){
				$edit_link = JURI::root() . 'index.php?option=com_virtuemart&tmpl=component&managing=1&view=product&task=edit&virtuemart_product_id=' . $product->virtuemart_product_id;
